...
def perturbed_moon(t, state, theta_GMST, mu=4902.8):
    ...
    x1999 = x1745*x647
    x2000 = x1751*x642
    # Break the huge x2001 expression into manageable chunks and sum them
    x2001_parts = []

    x2001_parts.append(x0*x1312*x1781 + x0*x1350*x1807 + x1052*x1228 + x1130*x1183*x1261*x1842 + x1130*x1775*x1784 + x1146*x1460*x1881 - 66643259867.0392*x1180*x1205*x1758 + x1184*x1315*x1781 + x1185*x1261*x1830)
    x2001_parts.append(x1191*x1322*x1881 + x1193*x1294*x1811*x1869 + x1194*x1348*x1807 + x1195*x1294*x1861 - x1202*x1763*x920 - x1202*x921 + x1214*x1774*x1776 + x1215*x947 + x1225*x943)
    x2001_parts.append(x1238*x880 + x1239*x875 + x1252*x1794*x1796 + x1275*x1850 + x1278*x1850 - x1279*x17*x1832*x1833 + x1315*x1883 + x1330*x1892 + x1333*x1892)
    x2001_parts.append(x1348*x1915 + x1398*x1932 - x14*x1849*x21 - x14*x1849*x7 + x1401*x1932 + x1440*x1954 + x1443*x1954 - 9028569.83119589*x1756*x1758 + x1758*x1780 + x1759*x1763 + x1759*x46)
    x2001_parts.append(1305280960058.79*x1760*x1761 + 8.80711838377931e+17*x1761*x1788 + x1764*x927 + x1764*x930 + x1767*x1768 + x1767*x1769 + 3045655573470.51*x1770*x1771 + 2.05499428954851e+18*x1771*x1809)
    x2001_parts.append(x1773*x451 - x1773*x923 + x1778*x1779 - x1778*x452*x922 + x1782*x906 + x1782*x909 + x1785*x1786 + x1785*x1789 + x1785*x1812)
    x2001_parts.append(x1786*x1802 + x1787*x906 + x1787*x909 + x1791*x29 - x1791*x912 + x1792*x1793 + x1792*x1797 + x1792*x1806 + x1792*x1814 + 5.92433421263338e+25*x1795*x1811)
    x2001_parts.append(x1798*x1800 - x1800*x34*x911 + x1801*x1813 + x1802*x1812 + x1803*x1804 + x1803*x1805 + x1806*x871 + x1808*x914 + x1808*x917)
    x2001_parts.append(x1815*x1816 + x1815*x1824 + x1816*x1817 + x1817*x1824 + x1819*x914 + x1819*x917 + x1820*x1821 + x1820*x1828 + x1821*x1822 + x1821*x1823 + x1821*x1827 + x1821*x1848 + x1821*x1851 + x1822*x1828 + x1823*x1828)
    x2001_parts.append(x1826*x866 - x1826*x925 + x1827*x1828 + x1828*x1848 + x1828*x1851 + x1829*x1831 + x1829*x1841 + x1831*x1834 + x1831*x1865 + x1831*x1866 + x1831*x1868 - 1.15045699501558e+32*x1833*x1844 + x1834*x1841)
    x2001_parts.append(x1836*x1837 - x1836*x742*x924 - x1839*x21 - x1839*x7 + x1841*x1865 + x1841*x1866 + x1841*x1868 + x1844*x1894*x1895 + x1845*x1846 + x1845*x1847 + x1845*x1859 + x1845*x1860 + x1845*x1867 + x1845*x1873 + x1845*x1878 + x1845*x1880)
    x2001_parts.append(x1846*x1854 + x1847*x1854 + x1853*x1893 + x1854*x1859 + x1854*x1860 + x1854*x1867 + x1854*x1873 + x1854*x1878 + x1856*x1857 + x1857*x1858 + x1862*x1863 + x1862*x1864 + x1862*x1906 + x1862*x1907 + x1862*x1913 + x1862*x1922 + x1862*x1927 + x1863*x1874 + x1864*x1874)
    x2001_parts.append(x1870*x1871 + x1870*x1872 + x1870*x1887 + x1870*x1888 + x1870*x1903 + x1870*x1905 + x1870*x1908 + x1870*x1912 + x1870*x1914 + x1870*x1918 + x1871*x1875 + x1872*x1875 + x1874*x1906 + x1874*x1907 + x1874*x1913 + x1874*x1922 + x1874*x1927 + x1875*x1887 + x1875*x1888 + x1875*x1903 + x1875*x1905 + x1875*x1908 + x1875*x1912 + x1875*x1914 + x1875*x1918)
    x2001_parts.append(x1876*x1877 + x1876*x1879 + x1876*x1901 + x1876*x1902 + x1876*x1923 + x1876*x1928 + x1876*x1933 + x1876*x1934 + x1876*x1945 + x1876*x1946 + x1876*x1947 + x1876*x1949 + x1877*x1891 + x1879*x1891 + x1882*x1883 + x1885*x1886 + x1885*x1941 + x1885*x1942 + x1885*x1952 + x1885*x1957 + x1885*x1962 + x1885*x1969 + x1885*x1972 + x1886*x1896)
    x2001_parts.append(x1890*x1909 + x1891*x1902 + x1891*x1923 + x1891*x1928 + x1891*x1933 + x1891*x1934 + x1891*x1945 + x1891*x1946 + x1891*x1947 + x1891*x1949 + x1896*x1904 + x1896*x1941 + x1896*x1942 + x1896*x1952 + x1896*x1957 + x1896*x1962 + x1896*x1969 + x1896*x1972 + x1898*x1899 + x1899*x1900)
    x2001_parts.append(x1910*x1911 + x1910*x1917 + x1910*x1919 + x1910*x1920 + x1910*x1953 + x1910*x1955 + x1910*x1956 + x1910*x1958 + x1910*x1966 + x1910*x1967 + x1910*x1970 + x1910*x1973 + x1910*x1974 + x1910*x1975 + x1911*x1921 + x1915*x1916 + x1917*x1921 + x1919*x1921 + x1920*x1921 + x1921*x1953 + x1921*x1955 + x1921*x1956 + x1921*x1958 + x1921*x1966 + x1921*x1967 + x1921*x1970 + x1921*x1973 + x1921*x1974 + x1921*x1975)
    x2001_parts.append(x1924*x1925 + x1924*x1926 + x1924*x1939 + x1924*x1940 + x1924*x1965 + x1924*x1968 + x1924*x1976 + x1924*x1977 + x1924*x1979 + x1924*x1980 + x1924*x1982 + x1924*x1983 + x1924*x1984 + x1924*x1985 + x1924*x1991 + x1924*x1993 + x1925*x1931 + x1926*x1931 + x1930*x1971 + x1931*x1939 + x1931*x1940 + x1931*x1968 + x1931*x1976 + x1931*x1977 + x1931*x1979 + x1931*x1980 + x1931*x1982 + x1931*x1983 + x1931*x1984 + x1931*x1985 + x1931*x1991 + x1931*x1993)
    x2001_parts.append(x1936*x1937 + x1937*x1938 + x1943*x1944 + x1943*x1948 + x1943*x1963 + x1943*x1964 + x1943*x1978 + x1943*x1981 + x1943*x1986 + x1943*x1987 + x1943*x1988 + x1943*x1990 + x1943*x1992 + x1943*x1994 + x1943*x1995 + x1943*x1996 + x1943*x1997 + x1943*x1998 + x1943*x1999 + x1943*x2000 + x1944*x1951 + x1948*x1951 + x1950*x1989 + x1951*x1963 + x1951*x1964 + x1951*x1978 + x1951*x1981 + x1951*x1986 + x1951*x1988 + x1951*x1990 + x1951*x1992 + x1951*x1994 + x1951*x1995 + x1951*x1996 + x1951*x1997 + x1951*x1998 + x1951*x1999 + x1951*x2000 + x1959*x1960 + x1960*x1961)

    x2001 = sum(x2001_parts)
    x2002 = x1757*x886
    x2003 = x453*x887
    x2004 = x10*x2003
